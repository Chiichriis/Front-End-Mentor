...
const Card = ({ info }) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center absolute top-36 w-full px-5'>
        <div className='bg-white rounded-xl w-full flex flex-col md:flex-row items-center justify-center p-2 md:w-2/3 md:h-28 md:items-left md:justify-start md:mt-8 z-10'>
